    ...
    <div class="container">
        <div class="row">
            <div class="col-12 text-center pt-5">
                <h1 class="display-one mt-5">Danh sách sinh viên</h1>
                <div class="text-left"><a href="http://127.0.0.1:8000/student" class="btn btn-outline-primary">Product List</a></div>
